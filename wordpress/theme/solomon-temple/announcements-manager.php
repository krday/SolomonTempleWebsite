...
.page-header-brand{display:flex;align-items:center;gap:.75rem}.page-header-brand img{width:44px;height:50px;object-fit:contain;filter:drop-shadow(0 2px 6px rgba(0,0,0,.4))}
...
<div class="page-header">
  <div class="page-header-brand"><img src="<?php echo get_template_directory_uri(); ?>/images/stmbc-logo.png" alt="Solomon Temple Logo"/>
